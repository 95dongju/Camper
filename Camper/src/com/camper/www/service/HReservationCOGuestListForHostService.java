...
public class HReservationCOGuestListForHostService implements Service {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) {
		...
		ArrayList<ReservationDto> rezList = rDao.getCOListforHost(s_hid, startRow, endRow);
		request.setAttribute("rezList", rezList);
		int totCnt = rDao.getTotCntCOforHost(s_hid);
