...
public class GReviewListService implements Service {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) {
		...
		ArrayList<ReviewDto> rvList = rvDao.reviewGuestList(s_gid, startRow, endRow);
		request.setAttribute("rvList", rvList);
		int totCnt = rvDao.getReviewGuestCnt(s_gid);
