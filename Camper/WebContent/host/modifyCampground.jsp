...
<body>
	...
	<div id="div_cg_rgst">
		<form action="${conPath }/modifyCampground.do?s_camp_no=${s_camp_no}" method="post" enctype="multipart/form-data">
			<h2>캠핑장 등록하기</h2>
			<br>
			<fieldset>
				<legend>캠핑장 기본 정보 </legend>
				<table>
					<tr>
						<td>캠핑장 이름</td>
						<td><input type="text" name="cgname" required="required" readonly="readonly"></td>
					</tr>
					<tr>
						<td>캠핑장 설명 </td>
					...
					<tr>
						<td>캠핑장 주소</td>
						<td><input type="text" name="cgaddr" required="required" readonly="readonly"></td>
					</tr>
					<tr>
						<td>캠핑장 연락처</td>
						<td><input type="text" name="cgtel" required="required" readonly="readonly"></td>
					</tr>
				</table>
			</fieldset>
			<br>
			<fieldset>
				<legend>캠핑장 시설 </legend>
				<div id="div_fieldset">
