...
-- 예약 수락 여부
SELECT GR.* FROM GUEST_RESERVATION GR WHERE S_SITE_NO = 'CS111112' AND D_SELECT LIKE TO_DATE('2023-03-30', 'YYYY-MM-DD');
...
-- 해당 년월에 예약된 내용 보기
SELECT * FROM GUEST_RESERVATION WHERE S_SITE_NO = 'CS111112' AND TO_CHAR(D_SELECT) = '' || '-' || '' ORDER BY D_REZ_DATE;
