...
-- 캠핑장 예약 수
SELECT GR.* FROM GUEST_RESERVATION GR, HOST_CAMPGROUND HC, HOST_CAMPSITE HS WHERE HS.S_SITE_NO = GR.S_SITE_NO AND HC.S_CAMP_NO =  HS.S_CAMP_NO AND HC.S_CAMP_NO = 'CG111111';
