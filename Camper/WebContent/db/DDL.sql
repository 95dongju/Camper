...
CREATE TABLE MEMBER_GUEST (
    ...
    S_GNICK VARCHAR2(100) NOT NULL UNIQUE,
    S_GTEL VARCHAR2(15) NOT NULL,
...
CREATE TABLE MEMBER_HOST (
    ...
    S_HTEL VARCHAR2(15) NOT NULL,
    S_HBIS_NAME VARCHAR2(100) NOT NULL,
    S_HBIS_NUM VARCHAR2(20) NOT NULL UNIQUE,
...
CREATE TABLE GUEST_RESERVATION(
    ...
    D_REZ_FROM DATE NOT NULL,
    D_REZ_TO DATE NOT NULL,
...
CREATE OR REPLACE TRIGGER HOST_CG_DEL
